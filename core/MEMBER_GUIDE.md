...
完整流程以 [`core/WORKFLOWS.md`](https://github.com/0xkey-io/enclave-keyops-skills/blob/main/core/WORKFLOWS.md) 为准。成员只需要知道自己会
...
仓库 README 的
[`Install / use with agents`](https://github.com/0xkey-io/enclave-keyops-skills#install--use-with-agents)
为准：
